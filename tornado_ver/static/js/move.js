...
function updateData(d) {
    ...
    for (var p in d.data) {
        // console.log(d[p].hp);
        data.tankShadows.push(d.data[p].tanks);
...
function checkPosition() {
    ...
    with (data.tank) {
        if (x<u) {
            x=u;
            x=data.prex;y=data.prey;speed=0;
        }
        if (x>1024-u) {
            x=1024-u;
            x=data.prex;y=data.prey;speed=0;
        ...
        switch (w) {
            case 1:x=200-u;x=data.prex;y=data.prey;speed=0;break;
            case 2:x=1024-200+u;x=data.prex;y=data.prey;speed=0;break;
            case 3:y=200-u;x=data.prex;y=data.prey;speed=0;break;
            case 4:y=200+u;x=data.prex;y=data.prey;speed=0;break;
            case 5:y=1024-200-u;x=data.prex;y=data.prey;speed=0;break;
            case 6:y=1024-200+u;x=data.prex;y=data.prey;speed=0;break;
            case 7:x=data.prex;y=data.prey;speed=0;break;
            case 8:x=data.prex;y=data.prey;speed=0;break;
        }
    }
}
...
//开始判定
    ...
    //        if (w) console.log(w);
            switch (w) {
                case 1:vx=-vx;x=2*(200-s)-x;x=prex;y=prey;break;
                case 2:vx=-vx;x=2*(1024-200+s)-x;x=prex;y=prey;break;
                case 3:vy=-vy;y=2*(200-s)-y;x=prex;y=prey;break;
                case 4:vy=-vy;y=2*(200+s)-y;x=prex;y=prey;break;
                case 5:vy=-vy;y=2*(1024-200-s)-y;x=prex;y=prey;break;
                case 6:vy=-vy;y=2*(1024-200+s)-y;x=prex;y=prey;break;
                case 7:var tmp=vx;vx=-vy;vy=-tmp;tmp=x;x=1024-s*Math.sqrt(2)-y;y=1024-s*Math.sqrt(2)-tmp;x=prex;y=prey;break;
                case 8:var tmp=vx;vx=-vy;vy=-tmp;tmp=x;x=1024+s*Math.sqrt(2)-y;y=1024+s*Math.sqrt(2)-tmp;x=prex;y=prey;break;
            }
        }
    }
